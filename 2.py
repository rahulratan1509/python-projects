...
T3 = Label(text='''Baba Garibnath Temple situated in the center of the Muzaffarpur town is undoubtedly
                   ...
                   He ordered him to establish the "Shivling" at the same place and call one ''', bg="red", fg="white", padx=5, pady=5)
T3.place(x=450, y=650)
# image
photo3 = PhotoImage(file="5.png")
